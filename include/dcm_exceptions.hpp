 ...
 * the Jewel library. They all have jewel::Exception as a (direct or
 * indirect) base class, which is defined in <jewel/exception.hpp>. Briefly,
 * a statement of the form "JEWEL_DERIVED_EXCEPTION(D, B)" declares and defines
 * an exception class D that publicly inherits from the class B.
 *
