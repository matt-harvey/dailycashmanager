 ...
 * the save or load methods of other such derived classes. Does this
 * matter? Does SQLite handle the nesting?
 *
...
public:
	 ...
	 *
	 * Note the PersistentObject base class function bookends
	 * execution with SQL "begin transaction" and "end transaction"
	 * commands.
	 */
	void save_new();
